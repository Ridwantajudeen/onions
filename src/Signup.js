      ...
      <div className="flex max-w-4xl w-full bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center px-8 py-10">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-xs mt-6 space-y-4">
            ...
            {userType && (
              <>
                <input type="text" name="fullName" placeholder="Full Name" required className="w-full border border-gray-300 rounded px-3 py-2 text-sm" />
                <input type="email" name="email" placeholder="Email" required className="w-full border border-gray-300 rounded px-3 py-2 text-sm" />
                ...
                <div className="relative">
                  ...
                  />
                  <img src={eyeIcon} alt="Toggle Password" className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 cursor-pointer" onClick={toggleShowPassword} />
                </div>
                ...
                <button type="submit" className="w-full bg-green-800 text-white text-sm font-medium py-2 rounded hover:bg-green-700 transition-colors">
                  Sign Up
                </button>
                ...
                <button type="button" onClick={handleGoogleSignup} className="w-full flex items-center justify-center border border-gray-300 rounded py-2 text-sm hover:bg-gray-100 transition-colors">
